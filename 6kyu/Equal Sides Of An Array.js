...
array and find an index N where the sum of the integers to the left of
N is equal to the sum of the integers to the right of N. If there is
...
const getSum = (arr, start, end = arr.length) => arr.slice(start, end).reduce((acc, arg) => acc + arg, 0);
const findEvenIndex = (arr) => arr.findIndex((arg, i) => getSum(arr, 0, i) === getSum(arr, i + 1));